...
async function buscarPrevisoesIA(periodo = 'amanha') {
    ...
    if (periodo === 'proxima-semana') {
        ...
        endpoints = [6, 10, 14, 18, 22, 2].map(h => ({ 

            hora: h, dia: diaSimulado 
        }));
    }
...
function configurarNavegacao() {
    ...
    const atualizarPeriodoUI = () => {
        ...
        document.querySelectorAll('.btn-inactive').forEach(btn => btn.classList.remove('active'));
